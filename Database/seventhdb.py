...
def fetch_data_from_mysql():
    ...
    try:
        ...
        fetch_query = "SELECT * FROM studseventh_marks"
...
seventh_std = fetch_data_from_mysql()

if seventh_std is not None:
    print("Data fetched successfully and stored in 'seventh_std'.")
else:
