...
#             insert_query = """
#                 INSERT INTO studtenth_marks (Student_id, Student_Name, Marathi, Urdu, Hindi, English, History, Science, Geography, Drawing, Sports, Environmental_Studies, Algebra, Geometry, Computer, Defence, Sanskrit)
...
#                 row.get('Drawing', 0),
#                 row.get('Sports', 0),
#                 row.get('Environmental_Studies', 0),
#                 row.get('Algebra', 0),
#                 row.get('Geometry', 0),
#                 row.get('Computer', 0),
#                 row.get('Defence', 0),
...
#     output_df = pd.read_csv('Data/10th_manual_ds.csv')  # Replace with actual file path or DataFrame
