...
subjects = [
    ...
    "Geography", "Drawing", "Sports", "Environmental_Studies", "Algebra","Geometry", "Computer","Defence","Sanskrit"
]
...
try:
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS unittest_10th_average (
            Student_id INT PRIMARY KEY,
            Marathi INT, Urdu INT, Hindi INT, English INT, History INT,
            Science INT, Geography INT, Drawing INT, Sports INT,
            Environmental_Studies INT, Algebra INT, Geometry INT,  Computer INT, Defence INT, Sanskrit INT,
            final_mark FLOAT
        )
    """)
    ...
    for Student_id in students:
        ...
        insert_query = f"""
            INSERT INTO unittest_10th_average (
